    ...
    for lag in lags:
        ...
        for visit_type in visit_types:
            ...
            for train_thresh_year in train_thresh_years:
                filename = "ethdonF_post{}_cutoff{}_deepsurv_{}_lag{}_perf.pkl".format(train_thresh_year,
                                                                                       "T" if cutoff else "F",
                                                                                       visit_type, lag)
                print(filename)
                if os.path.isfile(filename):
                    ...
                    print('{},deepsurv,{},{},{},{},{},{}'.format(train_thresh_year, visit_type, lag, cutoff, cindex,
                                                                 df.shape[0], cindex_case))
